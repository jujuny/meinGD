...
export const strings= {
    ...
    de: {
      ...
      'Sign Out': 'Abmelden',
      'Sign in to your account': 'Melde Dich mit Deinem Account an',
      'Email Address *': 'E-Mail-Adresse *',
      'Password': 'Passwort',
      'Sign in': 'Anmelden',
      'Create Account': 'Account anlegen',
      'Have an account?': 'Du hast einen Account?',
      'No account?': 'Noch nicht registriert?', 
      'Enter your email address': 'E-Mail-Adresse eintragen',
      'Enter your password': 'Passwort eintragen',
      'Create account': 'Account anlegen',
      'SIGN IN': 'ANMELDEN',
      ...
      CONFIRM: 'Confirm',
      CREATE_ACCOUNT_TEXT: 'Account anlegen',
